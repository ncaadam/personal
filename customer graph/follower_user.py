...
import requests
import sys
from frequent_methods import authenticate_url,set_twitter_keys
...
def grab_users_from_list(users):
    ...
    while user_bin < len(users):
        ...
        opener,auth_url = authenticate_url(access_token_key,access_token_secret,consumer_key,consumer_secret,non_auth_url)
